...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><strong><h3> ".$line_cost." VND</h3></strong>";
		echo "</tr>";
		}
		...
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'> ".$total." VND</h2></strong></td>";
		echo "<td></td>";
...
<br />
	<div id="footer">
		<div class="foot">
			<p style="font-size:25px;">Meow In 2020</p>
		</div>
